# 32. Cross-Signal Validation Common Contract (SPEC)

상태: Implemented
작성일: 2026-03-20
상위 SPEC: `docs/spec/19-cross-signal-validation-spec.md`
선행 SPEC: `docs/spec/30-cross-signal-validation-phase1-spec.md`, `docs/spec/31-cross-signal-validation-stale-config-phase2a-spec.md`
