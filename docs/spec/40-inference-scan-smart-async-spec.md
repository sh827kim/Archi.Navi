...
3. Smart Pipeline 추론은 브라우저 요청이 완료될 때까지 동기적으로 대기해야 한다.
...
3. Smart Pipeline을 비동기로 실행하고 완료/실패 알림을 제공한다.
...
3. Smart Pipeline 실행은 즉시 queue 응답을 반환하고, UI는 완료/실패 시 알림을 띄운다.
