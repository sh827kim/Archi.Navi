# 36. Cross-Signal Validation Finalization (SPEC)

상태: Implemented
작성일: 2026-03-20
상위 SPEC: `docs/spec/19-cross-signal-validation-spec.md`
선행 SPEC:
- `docs/spec/30-cross-signal-validation-phase1-spec.md`
- `docs/spec/31-cross-signal-validation-stale-config-phase2a-spec.md`
- `docs/spec/32-cross-signal-validation-common-contract-spec.md`
- `docs/spec/33-cross-signal-validation-phantom-call-spec.md`
- `docs/spec/34-cross-signal-validation-dead-topic-spec.md`
- `docs/spec/35-cross-signal-validation-orphan-fk-spec.md`
...
- `docs/spec/31-cross-signal-validation-stale-config-phase2a-spec.md` 를 C1 정식 문서로 유지한다.
- `docs/spec/31-cross-signal-validation-stale-config-phase2-spec.md` 는 제거한다.
- `docs/spec/32-cross-signal-validation-common-contract-spec.md` 를 공통 계약 문서로 유지한다.
