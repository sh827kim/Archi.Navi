...
| 추론 엔진 고도화 (P4) | ⚠️ | Cross-Signal Validation, Inter-procedural AST, LLM 추론 부스터(코드 의도 분석/관계 설명/도메인 라벨) 구현 완료. 4-4~4-6은 후속 고도화 범위 |
...
- ⚠️ Cross-Signal Validation, Inter-procedural AST, LLM 추론 부스터는 구현 완료되었고, 플러그인 시스템 / 실시간 갱신 / 피드백 루프가 다음 고도화 범위로 남아 있다.
...
| 4-3. LLM 추론 부스터 | `docs/spec/20-llm-inference-boost-spec.md` | ✅ Implemented |
