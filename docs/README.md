...
- `design/deprecated/*`: 대체된 레거시 설계 보관
...
- [36-relation-feedback-key-specialization-spec.md](./spec/36-relation-feedback-key-specialization-spec.md)
- [38-s1-phase2-ux-foundation-spec.md](./spec/38-s1-phase2-ux-foundation-spec.md)
- [39-workspace-folder-picker-spec.md](./spec/39-workspace-folder-picker-spec.md)
- [40-inference-scan-smart-async-spec.md](./spec/40-inference-scan-smart-async-spec.md)
- [41-db-recovery-migration-spec.md](./spec/41-db-recovery-migration-spec.md)
- [43-inference-run-ops-ux-spec.md](./spec/43-inference-run-ops-ux-spec.md)
- [44-query-engine-humanized-results-spec.md](./spec/44-query-engine-humanized-results-spec.md)
- [45-query-engine-input-usability-spec.md](./spec/45-query-engine-input-usability-spec.md)
- [46-ai-architecture-assistant-scope-expansion-spec.md](./spec/46-ai-architecture-assistant-scope-expansion-spec.md)
- [48-intent-centric-proof-engine-spec.md](./spec/48-intent-centric-proof-engine-spec.md)
- [49-intent-centric-proof-engine-state-model-spec.md](./spec/49-intent-centric-proof-engine-state-model-spec.md)
...
- [51-intent-centric-proof-engine-adoption-plan-spec.md](./spec/51-intent-centric-proof-engine-adoption-plan-spec.md)
- [52-embedded-postgres-runtime-migration-spec.md](./spec/52-embedded-postgres-runtime-migration-spec.md)
- [53-smart-proof-engine-escalation-spec.md](./spec/53-smart-proof-engine-escalation-spec.md)
- `spec/deprecated/*`: 더 이상 현행 기준이 아닌 레거시 SPEC 보관
